...
import pytest
import asyncio
from repology_mcp.client import RepologyClient, RepologyAPIError, RepologyNotFoundError
...
async def test_real_get_project_firefox():
    ...
    async with RepologyClient() as client:
        ...
        common_repos = {"arch", "fedora_41", "fedora_40", "ubuntu_24_04", "ubuntu_22_04", "debian_12", "debian_11"}
